...
import { useLoginMutation } from "@/ducks/apiSlice";
import { AdContainer } from "@/common/container";
import { AdCard } from "@/common/card";
import { AdLogo } from "@/common/logo";
import { AdTitle } from "@/common/title";
import { AdSubtitle } from "@/common/subtitle";
import { AdSpinner } from "@/common/spinner";
import { AdButton } from "@/common/button";
import { AdErrorBox } from "@/common/error";
import { AdFooter } from "@/common/footer";
import { AdForm } from "@/common/form";
import { AdErrorText } from "@/common/error-text";
import { AdInput } from "@/common/input";
import { AdLabel } from "@/common/label";
import { AdFormGroup } from "@/common/form-group";
import { AdLink } from "@/common/link";
type FormData = {
  email: string;
  password: string;
};
