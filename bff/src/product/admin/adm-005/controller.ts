...
/**
 * GET /adm-005/:sub/functions
 * Returns all UI functions with 3-state status for a user
 */
export const handle = async (req: Request, res: Response) => {
  try {
    ...
    const response = await apiClientGet(`/api/v1/admin/users/${sub}/functions/status`, {
